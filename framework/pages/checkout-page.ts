...
export class CheckoutPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.firstTermButton = this.termsAndConditionsContainer
      .locator('[class="btn btn-sm btn-outline-secondary"]')
      .nth(0);
    this.secondTermButton = this.termsAndConditionsContainer
      .locator('[class="btn btn-sm btn-outline-secondary"]')
      .nth(1);
    this.thirdTermButton = this.termsAndConditionsContainer
      .locator('[class="btn btn-sm btn-outline-secondary"]')
      .nth(2);
    this.fourthTermButton = this.termsAndConditionsContainer
      .locator('[class="btn btn-sm btn-outline-secondary"]')
      .nth(3);
